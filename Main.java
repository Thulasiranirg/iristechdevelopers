...
public class Main {
    ...
    private static void initializeMCQs() {
        mcqs = new ArrayList<>();
        mcqs.add(new MCQ("What is the capital of France?", Arrays.asList("A. London", "B. Paris", "C. Rome", "D. Madrid"), 1));
        mcqs.add(new MCQ("What is the largest planet in our solar system?", Arrays.asList("A. Venus", "B. Saturn", "C. Jupiter", "D. Earth"), 2));
